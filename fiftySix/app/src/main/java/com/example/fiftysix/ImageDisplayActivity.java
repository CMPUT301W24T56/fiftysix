...
/**
 * ImageDisplayActivity, displays all images to the admin, either profile or event poster images.
 * Allows deletion of selected photo.
 *
...
public class ImageDisplayActivity extends AppCompatActivity {
    ...
    /**
     * Fetches all event poster images and creates AdminImage object with the data, adds the objects to posterImages
     */
    ...
    /**
     * Fetches all event profile images and creates AdminImage object with the data, adds the objects to posterImages
     */
